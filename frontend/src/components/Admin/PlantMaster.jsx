  ...
  const toggleDropdown = (e, id) => {
    ...
    if (activeDropdown === targetId) {
      ...
      if (eventObj) {
        ...
        const container = btn.closest('.pc-table-container') || btn.closest('.table-responsive');
